...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _ui__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ui */ \"./src/ui.js\");\n/* harmony import */ var _project__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./project */ \"./src/project.js\");\n/* harmony import */ var _task__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./task */ \"./src/task.js\");\n\r\n\r\n\r\n\r\nconst retrieveProjects = () => {\r\n    if(localStorage.length == 0){\r\n        let newProject = Object(_project__WEBPACK_IMPORTED_MODULE_1__[\"Project\"])(\"Main\");\r\n        let newProjectTask = Object(_task__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(\"Create a new Project\", \"To create a new Project, type its name in the field in the left pane, then press Enter button.\", new Date().toDateInputValue(), \"important\");\r\n        newProject.addTask(newProjectTask);\r\n        let newTaskTask = Object(_task__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(\"Create a new Task\", \"To create a new Task, type its name in the field in the middle pane, then press Enter button OR type its name and details, choose deadline and priority, and click the check mark.\", new Date().toDateInputValue(), \"important\");\r\n        newProject.addTask(newTaskTask);\r\n        let markTaskDoneTask = Object(_task__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(\"Mark a Task as done\", \"To mark a Task as done, click a check mark. You can mark it as undone by clicking again.\", new Date().toDateInputValue(), \"important\");\r\n        newProject.addTask(markTaskDoneTask);\r\n        let deleteTaskTask = Object(_task__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(\"Delete a Task\", \"To delete a Task, click the cross mark. The Task will be permanently deleted.\", new Date().toDateInputValue(), \"important\");\r\n        newProject.addTask(deleteTaskTask);\r\n        let deleteProjectTask = Object(_task__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(\"Delete a Project\", \"To delete a Project, click the cross mark next to it in the list. The Project will be permanently deleted.\", new Date().toDateInputValue(), \"important\");\r\n        newProject.addTask(deleteProjectTask);\r\n        _project__WEBPACK_IMPORTED_MODULE_1__[\"projects\"].push(newProject);\r\n        \r\n    }\r\n    for(let i = 0; i < localStorage.length; i++){\r\n        let newProject = Object(_project__WEBPACK_IMPORTED_MODULE_1__[\"Project\"])(localStorage.key(i));\r\n        for(let j = 0; j < JSON.parse(localStorage.getItem(localStorage.key(i))).length; j++){\r\n            let taskTemplate = JSON.parse(localStorage.getItem(localStorage.key(i)))[j];\r\n            let newTask = Object(_task__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(taskTemplate[0], taskTemplate[1], taskTemplate[2], taskTemplate[3]);\r\n            if(taskTemplate[4]){\r\n                newTask.switchDone();\r\n            }\r\n            newProject.addTask(newTask);\r\n        }\r\n        _project__WEBPACK_IMPORTED_MODULE_1__[\"projects\"].push(newProject);\r\n    }\r\n}\r\n\r\nretrieveProjects();\r\nObject(_ui__WEBPACK_IMPORTED_MODULE_0__[\"initialiseApp\"])();\r\nObject(_ui__WEBPACK_IMPORTED_MODULE_0__[\"selectProject\"])(document.getElementsByClassName(\"project\")[0].innerHTML);\r\n\r\n\n\n//# sourceURL=webpack:///./src/index.js?");
